...
const GridMonitor = () => {
    ...
    const [currentStatus, setCurrentStatus] = useState({ voltage: 0, frequency: 0, status: "LOADING" });
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setData(prev => {
                    const newData = [...prev, { time: timeLabel, voltage: json.voltage, frequency: json.frequency }];
