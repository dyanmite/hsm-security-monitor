        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="relative w-full max-w-6xl aspect-video bg-zinc-900 border border-white/10 rounded-3xl overflow-hidden shadow-2xl"
                    onClick={(e) => e.stopPropagation()}
                >
                    {/* Header */}
                    <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-20 border-b border-white/5 bg-black/20">
                        <div>
                            <h2 className="text-2xl font-bold text-white flex items-center gap-3">
                                <Zap className="w-6 h-6 text-yellow-400" /> System Architecture
                            </h2>
                            <p className="text-sm text-slate-400">Real-time Data Flow & Trust Verification</p>
                        </div>
                    ...
                    {/* Flowchart Canvas */}
                    <div className="relative w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-blue-900/10 via-black to-black p-10 mt-10">
